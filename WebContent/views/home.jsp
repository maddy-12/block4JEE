		...
		<div class="row"
			...
			<div class="col-6"
				...
				<a class="btn btn-primary"
					style="margin-top: 191px; padding: 8px 85px;"
					href="/superhero/registerHero">Incription</a>
			</div>

			<div class="col-6"
				style="background-image: url('assets/incident.PNG');">
				<p>Besoin d'aide? Nous sommes là pour vous !</p>
				<a class="btn btn-primary"
					style="margin-top: 166px; padding: 8px 50px;"
					href="/superhero/reportIncident">Déclarer un incident</a>
			</div>
		</div>
	</div>
</body>
